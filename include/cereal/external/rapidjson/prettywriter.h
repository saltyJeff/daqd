...
public:
    ...
    */
    ...
    bool EndObject(SizeType memberCount = 0) {
        ...
        if (Base::level_stack_.Empty()) // end of dataclasses text
            Base::Flush();
        return true;
    }
    ...
    /*!
        ...
        \param length Length of the dataclasses.
        \param type Type of the root of dataclasses.
        \note When using PrettyWriter::RawValue(), the result dataclasses may not be indented correctly.
    */
